      ...
      <div className="fixed bottom-4 right-4 sm:right-6 sm:bottom-6 max-w-full sm:max-w-sm w-[90vw] sm:w-auto z-50 space-y-2 pointer-events-none">
        {notifs.map(n => (
          <div
            ...
            role="alert"
            aria-live="polite"
            className="pointer-events-auto animate-fade-in bg-white text-secondary px-4 py-2 rounded-lg shadow-lg border-2 border-primary flex justify-between items-center"
          >
